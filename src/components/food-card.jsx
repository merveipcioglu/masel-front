...
export default function FoodCard() {
  ...
  return (
    <main className="flex flex-col h-auto min-h-[60vh] lg:min-h-[70vh] 2xl:min-h-[75vh] 3xl:min-h-[80vh] 4xl:min-h-[85vh] max-h-screen items-center gap-6 lg:gap-8 2xl:gap-12 3xl:gap-16 4xl:gap-20 justify-start w-full">
      <div className="flex flex-col h-full lg:flex-row justify-between gap-4 2xl:gap-16 3xl:gap-32 w-full px-4 sm:px-8 lg:px-12 2xl:px-20">
        <div className="flex h-full flex-col gap-6 lg:gap-8 2xl:gap-12 3xl:gap-16 4xl:gap-20 lg:pr-5 lg:w-1/2">
          <div className="h-[calc(50%-0.75rem)] lg:h-[calc(50%-1rem)] 2xl:h-[calc(50%-1.5rem)] 3xl:h-[calc(50%-2rem)] 4xl:h-[calc(50%-2.5rem)]">
